 ...
 *
 *  WŁĄCZONE (1): projekt korzysta z LIDAR-a do SLAM/Stop-Scan-and-Go, więc
 *  musi być włączony w normalnej pracy. Przy 0 wszystkie funkcje w lidar.c
 *  są pustymi zaślepkami - lidar_copy_scan() zawsze zwraca 0 punktów, a
 *  lidar_min_in_arc() zawsze "brak echa / otwarte". Skutek: SLAM w Pythonie
 *  nigdy się nie zbootstrapuje (zbyt mało punktów skanu), a autonomia nigdy
 *  nie wykryje przeszkody lidarem - i to bez żadnego błędu w logach, po
 *  prostu cicho "nic nie widzi". Do debugowania przez USB-Serial przełącz
 *  z powrotem na 0 - logi w tym czasie są i tak dostępne przez monitor
 *  webowy (main.c: web_monitor_init()).
 */
