...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("C:/Projects/autonomous_vehicle/build/esp-idf/mbedtls/mbedtls/cmake_install.cmake")
endif()

string(REPLACE ";" "\n" CMAKE_INSTALL_MANIFEST_CONTENT
       "${CMAKE_INSTALL_MANIFEST_FILES}")
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "C:/Projects/autonomous_vehicle/build/esp-idf/mbedtls/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
